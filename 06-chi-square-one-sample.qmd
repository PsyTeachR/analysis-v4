...
A Q-Q plot is the best way to check whether the **residuals of the DV are approximately normally distributed** visually. The Shapiro-Wilk's test is a computational alternative suitable for small sample sizes.
...
Both options show that **the residuals are normally distributed**. This allows us to proceed with a parametric test, specifically a one-sample t-test.


##### Alternative: Shapiro Wilk's test {.unnumbered}
